...
router.get('/:id', async (req, res, next) => {
  try {
    const match = await Match.findById(req.params.id)
      ...
      .populate('toss.winner', 'name code')
      .populate('result.winner', 'name code')
      .populate('squads.team1.player', 'name role battingStyle bowlingStyle headshotPath imageUrl')
      .populate('squads.team2.player', 'name role battingStyle bowlingStyle headshotPath imageUrl')
