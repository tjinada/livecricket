...
export class MatchDisplayComponentRefactored implements OnInit, OnDestroy {
  // NOTE: This is the refactored version using sub-components
  // The original inline template class follows below
}

// ============= ORIGINAL COMPONENT (keeping for reference during transition) =============
@Component({
  selector: 'app-match-display-original',
  standalone: true,
