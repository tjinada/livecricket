  ...
  template: `
    <div class="min-h-screen bg-gray-900 text-white">
      ...
      <div *ngIf="!loading && !error && match">
        <!-- Live Score View -->
        <div *ngIf="displayView === 'score-summary'" class="relative min-h-screen flex items-end pb-8">
          <div class="absolute inset-0 bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900"></div>
          
          <div class="relative w-full px-4">
            <div class="flex items-stretch bg-gradient-to-r from-gray-800 via-gray-700 to-gray-800 rounded-lg overflow-hidden shadow-2xl">
              
              <!-- Batting Team Section -->
              <div class="flex items-center gap-4 px-4 py-3 bg-gradient-to-r from-blue-900 to-blue-800">
              ...
              <!-- Main Score -->
              <div class="flex-1 flex items-center justify-center px-6 py-3 bg-gradient-to-r from-green-700 to-green-600">
                <div class="text-center">
              ...
              <!-- Bowler Section -->
              <div class="flex items-center gap-4 px-4 py-3 bg-gradient-to-r from-gray-700 to-gray-600">
                <div class="flex flex-col text-sm">
            ...
            <!-- Run Rate Bar -->
            <div class="flex items-center justify-between mt-2 px-4 text-sm">
        ...
        <div *ngIf="displayView === 'player-stats'" class="p-6 max-w-5xl mx-auto">
          ...
          <!-- Batting Card -->
          <div class="bg-gradient-to-r from-blue-900 to-blue-800 rounded-lg overflow-hidden shadow-xl mb-6">
            <div class="grid grid-cols-12 gap-2 px-4 py-2 bg-blue-950 text-xs text-gray-400 uppercase">
          ...
          <!-- Bowling Card -->
          <div class="bg-gradient-to-r from-gray-800 to-gray-700 rounded-lg overflow-hidden shadow-xl">
            <div class="grid grid-cols-12 gap-2 px-4 py-2 bg-gray-900 text-xs text-gray-400 uppercase">
          ...
          <!-- Fall of Wickets -->
          <div *ngIf="getFallOfWickets().length > 0" class="mt-6 bg-gray-800/50 rounded-lg p-4">
        ...
        <div *ngIf="displayView === 'overall-summary'" class="p-6 max-w-5xl mx-auto">
          <div class="bg-gradient-to-r from-blue-600 to-blue-800 rounded-t-lg px-6 py-4">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-0">
            <ng-container *ngFor="let innings of match.innings; let idx = index">
              <div 
                class="bg-gradient-to-b from-gray-800 to-gray-900 p-4"
          ...
          <div class="bg-gradient-to-r from-gray-700 to-gray-800 rounded-b-lg px-6 py-4">
        ...
        <div *ngIf="displayView === 'projections'" class="p-6 max-w-5xl mx-auto">
          ...
          <div class="bg-gradient-to-b from-gray-800 to-gray-900 rounded-lg p-6 mb-6">
          ...
          <div *ngIf="match.currentInnings === 1" class="bg-gradient-to-r from-blue-900 to-blue-800 rounded-lg px-6 py-4 text-center">
          ...
          <div *ngIf="match.currentInnings === 1" class="mt-6 bg-gray-800 rounded-lg p-6">
        ...
        <!-- View Indicator -->
        <div class="fixed bottom-4 right-4 bg-black/50 px-3 py-1 rounded text-xs text-gray-400">
          {{ getViewName() }}
        </div>
      </div>
    </div>
...
export class MatchDisplayComponent implements OnInit, OnDestroy {
  ...
  getTopBowlersForInnings(inningsIndex: number, count: number): any[] {
    // Get bowlers from the opposite innings (they bowled in this innings)
